package chap07_exception.pkg02;
/**
...
public class NullPointerExample {
	public static void main(String[] args) {
		String data = null;	//String type 클래스 변수 data선언
		/**
		 * try {
		 *... 예외 발생 가능성이 있는 코드
		 * }catch{
		...
		try {
			...
			System.out.println(stu.a);	// 예외 발생하는 부분 (객체 생성 후 초기화
		} catch (NullPointerException e) {
			System.out.println("NullPointerExample 예외 발생");
